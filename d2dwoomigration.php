...
/*
Plugin Name: D2dSoft WooCommerce Data Migration
Plugin URI: https://d2d-soft.com
Description: WooCommerce Data Migration by D2dSoft will let you to import/export all your products, orders, customers, categories, reviews and other entities, preserving relations between them.
Author: D2dSoft
Version: 1.0.0
...
class D2dWooMigration
{
    ...
    public function run(){
        ...
        add_action('admin_post_dwm_license_form', array($this, 'submitLicenseForm'));
        add_action('admin_post_dwm_setting_form', array($this, 'submitSettingForm'));
        add_action('wp_ajax_d2d_woomigration', array($this, 'processAjax'));
    }
    ...
    public function display(){
        if(!$this->isInstallLibrary()){
            ...
            if(!is_writeable($folder)){
                $folder_name = 'd2dwoomigration' . $this->getLibraryLocation();
    ...
    protected function getMigrationApp()
    {
        ...
        D2dInit::initEnv();
        $app = D2dInit::getAppInstance(D2dInit::APP_HTTP, D2dInit::TARGET_RAW, 'woocommerce');
    ...
    public function redirectPluginPage($page_type = ''){
        ...
        $this->redirectToPage('woomigration', $params);
        return;
    }
    ...
    public function getPluginPage($page_type = ''){
        ...
        return $this->getAdminPage('woomigration', $params);
    }
...
D2dWooMigration::getInstance()->run();